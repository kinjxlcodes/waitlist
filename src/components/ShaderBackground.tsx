  ...
  return (
    <div className="absolute inset-0 w-full h-full">
      ...
      >
        <ShaderGradient
          control='query'
          urlString={isDark ? darkModeUrl : lightModeUrl}
        />
      </ShaderGradientCanvas>
    </div>
  )
